...
% {'Stimulus' 'Start Time [ms]' 'End Time [ms]' 'Blink Start [ms]' 'Blink Duration [ms]' 'Blink End [ms]' 'Eye L/R' 'Number'}
try
    % Initialization
    ...
    eye = struct(...
        'info', struct('subject', [], 'color', []), ...
        'stimulus', struct('unit', 'ms', 'trial', [], 'color', [], 'name', [], 'start', [], 'end', []), ...
        'blink', struct('unit', 'ms', 'start', [], 'end', [], 'duration', [], 'side', [], 'number', []));
    ...
    %
    %     blink = struct('info', struct('sampleRate', [], 'version', [], 'file', [], 'date', []), ...
